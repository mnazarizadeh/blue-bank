...
@Slf4j
public class AccountClientErrorDecoder extends ErrorDecoder.Default {

	private final ObjectMapper objectMapper;

	public AccountClientErrorDecoder() {
	...
	private ErrorResponse read(Response response) {
		try {
			return objectMapper.readValue(response.body().asReader(StandardCharsets.UTF_8), ErrorResponse.class);
		} catch (IOException e) {
